...
$("#completeOrder").click(function () {
    ...
    console.log("Is the drink decaf: " + document.getElementsByID("decaf").value)
    console.log("Is the drink decaf: " + document.getElementsByID("noDecaf").value)
    console.log("the amount of sugars is: " + document.getElementById("sugars").value)
    console.log("the payment type is: " + document.getElementByName("paymentPaperMoney").value)
    console.log("the payment type is: " + document.getElementByName("paymentOnlineMoney").value)
})
